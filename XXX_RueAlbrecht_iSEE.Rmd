...
However, users are free to rearrange, resize, remove or add panels freely, as described in a later section.
...
The creation and configuration of custom panels is discussed later, in a dedicated section of the workshop.
...
We discuss point transmission in more detail later in the workshop.
...
Each of these is discussed in more detail later in the workflow.
