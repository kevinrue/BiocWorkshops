...
**Action:** Using your open `r Biocpkg("iSEE")` instance, open the `Organization` menu and click on the `Organize panels` button.
...
**Action:** Run the following block of code to show two _Reduced dimension plot_ panels; one showing the PCA representation, one showing the t-SNE representation.
...
**Action:** Run the following block of code to continue editing the configuration of the two _Reduced dimension plot_ panels prepared in the [previous section](#choose-reduced-dimension).
...
**Action:** Run the following block of code to set up 3 panels, all displaying the t-SNE representation.
...
**Action:** Run the following block of code to continue editing the configuration of the two _Reduced dimension plot_ panels prepared in the [previous section](#color-by-feature).
...
**Action:** Run the following block of code to continue editing the configuration of the two _Reduced dimension plot_ panels prepared in the [previous section](#color-by-feature).
Here, we reduce the point size and increase the transparency (i.e. reduced the alpha channel).
...
**Action:** Run the following block of code to set up one _Column data plot_ and one _Row data plot_ panel.
